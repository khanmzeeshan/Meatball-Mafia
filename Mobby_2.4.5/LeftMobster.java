...
/**
 * Write a description of class LeftMobster here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class LeftMobster extends ScrollingActor
{
    ...
    int mobbyDist = 500; //distance mobster checks for Mobby to shoot
    int speed = 4; //speed that mobster moves
    ...
    int bi; 
    public static final int NUM_FRAGMENTS = 100;
