...
/**
 * Write a description of class ChefHitbox here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class ChefHitbox extends ScrollingActor
{
    GreenfootImage body;
    int offsetX;
    int offsetY;
    ...
    public ChefHitbox(Actor a, int w, int h, int dx, int dy, boolean visible)
    {
        host = a;
        offsetX = dx;
        offsetY = dy;
